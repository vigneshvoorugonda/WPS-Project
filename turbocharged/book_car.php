...
<section class="">
		...
		?>
			...
			<section class="caption">
				<h2 class="caption" style="text-align: center">Service booking for your vehicle</h2>
	...
	<section class="listings">
		<div class="wrapper">
			...
			?>
				...
				<h3>Proceed to book service request for your <?php echo $rws['car_type'];?>. </h3>
				<?php
				...
				<?php
						if(isset($_POST['save'])){
							...
							$qry = "INSERT INTO client (fname,reg_no,gender,email,phone,location,car_id,status)
